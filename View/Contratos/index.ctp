...
<!-- <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Contratos prox. a vecer'), array('action' => 'vencidos'), array('escape' => false)); ?> </li>-->
                        </ul>
                    </div><!-- end body -->
                </div><!-- end panel -->
            </div><!-- end actions -->
            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('conTipo', $title = 'Tipo'); ?></th>
<!--                        <th><?php echo $this->Paginator->sort('Plazo'); ?></th>
                        <th><?php echo $this->Paginator->sort('Fecha Inicio'); ?></th>-->
                        <th><?php echo $this->Paginator->sort('conFecFin', $title = 'Fecha Fin'); ?></th>
                        <th><?php echo $this->Paginator->sort('personal_id', $title = 'Personal Contratado'); ?></th>

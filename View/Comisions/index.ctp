                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Nueva Comisión'), array('action' => 'add'), array('escape' => false)); ?></li>
...
<!--                        <th><?php echo $this->Paginator->sort('id'); ?></th>-->
                        <th><?php echo $this->Paginator->sort('Nombre', $title = 'Nombre'); ?></th>
                        <th><?php echo $this->Paginator->sort('Lugar', $title = 'Lugar'); ?></th>
                        <th class="actions"></th>
                    </tr>
                </thead>
                <tbody>
...
<!--                        <td><?php echo h($comision['Comision']['id']); ?>&nbsp;</td>-->
                        ...
                        <td><?php echo h($comision['Comision']['Lugar']); ?>&nbsp;</td>
                        <td class="actions">
                            <?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $comision['Comision']['id']), array('escape' => false)); ?>
                            <?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $comision['Comision']['id']), array('escape' => false)); ?>
                            <?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $comision['Comision']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $comision['Comision']['id'])); ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>

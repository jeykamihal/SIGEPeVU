    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1><?php echo __('Editar Comisión'); ?></h1>
            </div>
        </div>
    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Borrar'), array('action' => 'delete', $this->Form->value('Comision.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Comision.id'))); ?></li>
...
<!--                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Personal'), array('controller' => 'personals', 'action' => 'add'), array('escape' => false)); ?> </li>-->
        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                <?php echo $this->Form->input('Nombre', array('class' => 'form-control', 'label' => 'Nombre de la Comisión','placeholder' => 'Nombre'));?>
            </div>
            <div class="form-group">

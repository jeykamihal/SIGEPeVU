    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1><?php echo __('Editar Personal'); ?></h1>
            </div>
        </div>
    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Borrar'), array('action' => 'delete', $this->Form->value('Personal.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Personal.id'))); ?></li>
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;Lista Personal'), array('action' => 'index'), array('escape' => false)); ?></li>
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;Lista Comisiones'), array('controller' => 'comisions', 'action' => 'index'), array('escape' => false)); ?> </li>
...
<!--                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Equipo'), array('controller' => 'equipos', 'action' => 'add'), array('escape' => false)); ?> </li>-->
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;Lista Bonificaciones'), array('controller' => 'bonificacions', 'action' => 'index'), array('escape' => false)); ?> </li>
